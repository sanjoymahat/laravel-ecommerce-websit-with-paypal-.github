                    ...
                    <div class="col-md-3">
                        ...
                        <div class="product-single">
                            ...
                            <div class="product-content">
                                <h2>
                                    <a href="{{route('single_product',['id'=>$item->id])}}" > {{$item->name}}</a>
                                </h2>
                                @if($item->sale_price !=null)
                                <h3>${{$item->sale_price}}</h3>
                                <h3><div style="text-decoration: line-through;">${{$item->price}}</div></h3>
                                @else
                                <h3>${{$item->price}}</h3>
                                @endif
                                <form method="POST" action="{{ route('add_to_cart') }}">
                                    ...
                                    <input type="hidden" name="image" value="{{ $item->image }}"/> <!-- Corrected line -->
            ...
            <div class="row">
                ...
                <div class="col-lg-4 py-5 py-lg-0" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="{{asset('img/product-1.png')}}" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-4 py-0 py-lg-5">
